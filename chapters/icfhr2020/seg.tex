...
\begin{figure}[h]
	...
	\caption{Examples of the data model and intermediate representations
		 for a page from the
		 BADAM\cite{kiessling2019badam} dataset}
\end{figure}
...
\footnotetext[3]{Calculated on random 200 pages of the test set.}
\footnotetext[4]{Combined region and baseline model}
\begin{table}[h!]
\begin{center}
...
%\begin{description}[\settowidth{\labelwidth}{frequency weighted IU}]
