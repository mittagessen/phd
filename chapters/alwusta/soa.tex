...
\begin{enumerate}
	\item The typeface of works \#4-5 is different than work \#1 and it utilizes a number of ligatures that are not present in the typeface of work \#1 (for examples, see table~\ref{tab:soa_tab3} below). 
